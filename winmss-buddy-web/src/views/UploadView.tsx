...
import { MatchController } from '../controllers/MatchController'; // Import the MatchController
...
const UploadView: React.FC = () => {
    const { setProcessedData } = useAppContext();
    const [fileList, setFileList] = useState<FileProgress[]>([]);
    const [uploading, setUploading] = useState<boolean>(false);
    const matchController = new MatchController(); // Create an instance of MatchController
    ...
    // Get match names using the MatchController
    const matchNames = matchController.getMatchNames();
        ...
        <div>
            ...
            {matchNames.length > 0 && (
                <div style={{ marginTop: "24px" }}>
                    ...
                    <List
                        bordered
                        dataSource={matchNames} // Use match names from the controller
